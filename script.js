...
const rottenApple = {
  songName : 'Rotten Apple',
  artist : 'Alice in Chains',
  file : 'alice_in_chains',
  liked: false
};

const isItReallyYou = {
  songName : 'Is It Really You?',
  artist : 'Loathe',
  file : 'loathe',
  liked: false
};
...
let repeatOn = false;
const originalPlaylist = JSON.parse(localStorage.getItem('playlist')) ?? [rottenApple, isItReallyYou, yourFace];
